...
facerec = dlib.face_recognition_model_v1(face_rec_model_path)   # ResNet?
...
try:
#   test_path=input('请输入要检测的图片的路径:')
    img = io.imread(r"C:\Users\19528\Desktop\img\mij_yangmi证件\00016-426107957.jpg")
    dets = detector(img, 1)
except:
    print('输入路径有误，请检查！')
